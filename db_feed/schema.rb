...
ActiveRecord::Schema.define(version: 2018_09_26_175210) do
  ...
  create_table "jpm_flex_lookup", id: false, force: :cascade do |t|
    t.string "account_number", limit: 32
  ...
  create_table "jpm_prod_lookup", id: false, force: :cascade do |t|
    t.string "account_number", limit: 32
    t.string "account_name", limit: 128
    t.string "ticker", limit: 32
  end
  ...
  create_table "jpms_ffcm", force: :cascade do |t|
    ...
    t.string "cash_account_ccy", limit: 3
  ...
  create_table "jpms_pos_lookup", id: false, force: :cascade do |t|
    t.string "account_number", limit: 32
    t.string "account_name", limit: 128
    t.string "ticker", limit: 32
  end
  ...
  create_table "jpms_profund_lookup", id: false, force: :cascade do |t|
    t.string "account_number", limit: 32
    t.string "account_name", limit: 128
    t.string "ticker", limit: 32
  end
  ...
  create_table "ssc_lookups", id: false, force: :cascade do |t|
    t.string "fund_id", limit: 4
    t.string "fund_name", limit: 128
    t.string "ticker", limit: 32
  ...
  create_table "usbank_pcf", id: false, force: :cascade do |t|
    ...
    t.decimal "basketmarketvalue", precision: 18, scale: 6
    t.decimal "price", precision: 18, scale: 6
    t.decimal "shares", precision: 18, scale: 6
    t.decimal "securitymarketvalue", precision: 18, scale: 6
    t.text "corporateactionapplied"
    t.text "cilflag"
    t.text "basketid"
    t.decimal "nav", precision: 18, scale: 6
    t.decimal "estimatedcash", precision: 18, scale: 6
    t.decimal "actualcashamount", precision: 18, scale: 6
    t.decimal "sharesoutstanding", precision: 18, scale: 6
    t.decimal "currentxrate", precision: 18, scale: 6
  end
