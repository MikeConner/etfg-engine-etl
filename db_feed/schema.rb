...
ActiveRecord::Schema.define(version: 2018_08_20_081053) do
  ...
  create_table "vanguard_us_all_fund_holdings", force: :cascade do |t|
  ...
  create_table "vanguard_us_etfnav", force: :cascade do |t|
    t.string "ticker"
    t.string "isin"
    t.string "sedol"
    t.string "cusip"
  ...
  create_table "vanguard_us_fi_etfnav", force: :cascade do |t|
    t.string "ticker"
    t.string "isin"
    t.string "sedol"
    t.string "cusip"
