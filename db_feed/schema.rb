...
ActiveRecord::Schema.define(version: 2019_06_20_202740) do
  ...
  create_table "bmo_etn", id: false, force: :cascade do |t|
    t.date "etfg_date"
    t.decimal "base_value", precision: 22, scale: 6
    t.date "date"
    t.decimal "etn_market_value", precision: 22, scale: 6
    t.string "ticker", limit: 6
    t.decimal "leverage_factor", precision: 22, scale: 6
    t.string "sod_or_eod", limit: 3
    t.decimal "shares_outstanding", precision: 22, scale: 6
    t.decimal "t_1_financing_level", precision: 22, scale: 6
    t.decimal "total_assets", precision: 22, scale: 6
    t.decimal "total_etn_shares", precision: 22, scale: 6
  end

  create_table "bmo_etn_template", id: false, force: :cascade do |t|
    t.text "base_value"
    t.text "date"
    t.text "etn_market_value"
    t.text "ticker"
    t.text "leverage_factor"
    t.text "sod_or_eod"
    t.text "shares_outstanding"
    t.text "t_1_financing_level"
    t.text "total_assets"
    t.text "total_etn_shares"
  end
  ...
  create_table "invesco_basket_constituents", id: false, force: :cascade do |t|
    t.date "etfg_date"
    t.string "fund_ticker", limit: 32
    t.string "isin", limit: 12
    t.string "cusip", limit: 9
    ...
    t.decimal "market_value", precision: 22, scale: 6
    t.decimal "dirty_market_value", precision: 22, scale: 6
    t.string "excluded", limit: 3
    t.string "cash_in_lieu", limit: 3
    t.string "security_type", limit: 64
    t.decimal "index_ratio", precision: 22, scale: 6
    t.decimal "sink_factor", precision: 22, scale: 6
    t.decimal "mortgage_factor", precision: 22, scale: 6
    t.decimal "fund_market_value", precision: 22, scale: 6
    t.date "as_of_date"
  end

  create_table "invesco_basket_constituents_template", id: false, force: :cascade do |t|
    t.text "fund_ticker"
    t.text "isin"
    t.text "cusip"
    t.text "sedol"
    ...
    t.text "market_value"
    t.text "dirty_market_value"
    t.text "excluded"
    t.text "cash_in_lieu"
    t.text "security_type"
    t.text "index_ratio"
    t.text "sink_factor"
    t.text "mortgage_factor"
    t.text "fund_market_value"
    t.text "as_of_date"
  end

  create_table "invesco_basket_fund", id: false, force: :cascade do |t|
    t.date "etfg_date", null: false
    t.date "as_of_date", null: false
    t.string "fund_ticker", limit: 32
    t.string "fund_name", limit: 128
    t.string "cusip", limit: 9
    t.string "standard_cusip", limit: 9
    t.decimal "nav", precision: 22, scale: 6
    t.decimal "shares_outstanding", precision: 22, scale: 6
    t.decimal "creation_unit_size", precision: 22, scale: 6
    t.decimal "nav_per_creation_unit", precision: 22, scale: 6
    t.decimal "estimated_cash", precision: 22, scale: 6
    t.decimal "estimated_cash_per_ind", precision: 22, scale: 6
    t.decimal "total_cash", precision: 22, scale: 6
  end

  create_table "invesco_basket_fund_template", id: false, force: :cascade do |t|
    t.text "fund_ticker"
    t.text "fund_name"
    t.text "cusip"
    t.text "standard_cusip"
    t.text "nav"
    t.text "shares_outstanding"
    t.text "creation_unit_size"
    t.text "nav_per_creation_unit"
    t.text "estimated_cash"
    t.text "estimated_cash_per_ind"
    t.text "total_cash"
    t.text "as_of_date"
  end
  ...
  create_table "staging_basket_composites", force: :cascade do |t|
    t.date "etfg_date", null: false
    t.date "as_of_date", null: false
    ...
    t.index ["as_of_date", "datasource_id"], name: "index_basket_composites_on_as_of_date_and_datasource_id"
    t.index ["composite_ticker", "exchange_country"], name: "index_basket_composites_on_ticker_country"
    t.index ["composite_ticker"], name: "index_basket_composites_on_composite_ticker"
    t.index ["etfg_date", "datasource_id"], name: "index_basket_composites_on_etfg_date_and_datasource_id"
    t.index ["pooled_instrument_id"], name: "index_basket_composites_on_pooled_instrument_id"
  end

  create_table "staging_basket_constituents", force: :cascade do |t|
    t.date "etfg_date", null: false
    t.date "as_of_date", null: false
    ...
    t.text "trace"
    t.index ["composite_ticker", "exchange_country"], name: "sbc_ticker_country_constituents"
    t.index ["composite_ticker"], name: "index_basket_staging_constituents_on_composite_ticker"
    t.index ["etfg_date", "datasource_id", "instrument_id"], name: "basket_staging_date_source_instrument"
    t.index ["etfg_date", "datasource_id", "instrument_id"], name: "index_sbc_on_date_source_instrument"
    t.index ["etfg_date", "datasource_id"], name: "index_basket_staging_constituents_on_date_id"
    t.index ["etfg_date"], name: "index_basket_staging_constituents_on_etfg_date"
    t.index ["figi"], name: "index_basket_staging_constituents_on_figi"
    t.index ["instrument_id"], name: "index_basket_staging_constituents_on_instrument_id"
  end
  ...
  create_table "vanguard_basket_constituents", id: false, force: :cascade do |t|
    t.date "etfg_date"
    t.date "as_of_date"
    t.string "composite_ticker", limit: 32
    t.string "sedol", limit: 7
    ...
    t.decimal "basket_quantity", precision: 22, scale: 6
    t.string "cash_in_lieu_indicator", limit: 3
    t.string "tba_indicator", limit: 3
    t.string "security_id", limit: 20
    t.string "security_id_type", limit: 32
    t.string "cins", limit: 12
  end

  create_table "vanguard_basket_constituents_template", id: false, force: :cascade do |t|
    t.text "composite_ticker"
    t.date "trade_date"
    t.text "sedol"
    t.text "isin"
    t.text "description"
    t.text "basket_quantity"
    t.text "cash_in_lieu_indicator"
    t.text "tba_indicator"
    t.text "security_id"
    t.text "security_id_type"
    t.text "cins"
  end

  create_table "vanguard_basket_fund", id: false, force: :cascade do |t|
    t.date "etfg_date"
    t.string "fund_name", limit: 128
    t.string "fund_identifier", limit: 12
    t.string "fund_identifier_type", limit: 32
    t.string "domicile", limit: 10
    t.string "fund_ticker", limit: 32
    t.date "trade_date"
    t.decimal "unit_size", precision: 22, scale: 6
    t.decimal "shares_outstanding", precision: 22, scale: 6
    t.decimal "nav", precision: 22, scale: 6
    t.string "basket_identifier", limit: 32
  ...
  create_table "vanguard_basket_fund_template", id: false, force: :cascade do |t|
    t.text "fund_name"
    t.text "fund_identifier"
